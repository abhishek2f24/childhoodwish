  ...
  const handlePayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/orders/create', {
        ...
        body: JSON.stringify({ amount: (total + (total < 799 ? 79 : 0)) * 100, customer: form, items }),
      });
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="card p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { id: 'name', label: 'Full Name', type: 'text', placeholder: 'Abhishek Kumar', col: 2 },
                    { id: 'email', label: 'Email', type: 'email', placeholder: 'you@example.com', col: 1 },
                    { id: 'phone', label: 'Phone', type: 'tel', placeholder: '+91 98765 43210', col: 1 },
                    { id: 'address', label: 'Address', type: 'text', placeholder: 'House no., Street, Area', col: 2 },
                    { id: 'city', label: 'City', type: 'text', placeholder: 'Vadodara', col: 1 },
                    { id: 'state', label: 'State', type: 'text', placeholder: 'Gujarat', col: 1 },
                  ].map((field) => (
                    <div key={field.id} className={`col-span-${field.col}`}>
            ...
            <div className="lg:col-span-1">
              <div className="card p-6 sticky top-24">
                ...
                >
                  {loading ? 'Preparing...' : `Pay ${formatPrice(grandTotal)}`}
                </button>
